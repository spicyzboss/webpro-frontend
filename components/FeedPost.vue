<template>
  <div class="mt-4 rounded-lg bg-white w-full border drop-shadow-md static">
    <div class="w-full flex justify-between p-3">
      ...
      <span class="px-2 hover:bg-gray-300 cursor-pointer rounded"><i class="fas fa-ellipsis-h pt-2 text-lg" /></span>
    ...
    <div class="px-4 max-w-lg h-max">
      <h2 class="text-gray-800 text-2xl font-semibold w-full">
        Design Tools
      </h2>
      ...
      <h2 class="text-gray-800 text-xl font-semibold w-full">
